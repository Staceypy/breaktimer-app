...
const defaultSettings: Settings = {
  ...
  breakFrequency: new Date(0, 0, 0, 0, 40),
  breakLength: new Date(0, 0, 0, 0, 3),
  ...
  workingHoursSaturday: true,
  workingHoursSunday: true,
  idleResetEnabled: true,
  idleResetLength: new Date(0, 0, 0, 0, 5),
  idleResetNotification: false,
  gongEnabled: false,
  breakTitle: "Time For Stand Up!",
  breakMessage: "Stand Up. Rest your eyes. Stretch. Breathe. Relax :D",
  backgroundColor: "#AA9AD0",
  backdropColor: "#02144B",
  textColor: "#ffffff",
  showBackdrop: true,
  backdropOpacity: 0.7,
